...
<html>
<head>
<title>Entrega de solicitudes</title>
...
<script type="text/javascript" src="entrega.js"></script>
</head>
<body>
  <table width="95%" align="center"><tr><td><h1>Salidas - Relación de pedidos para entrega</h1></td></tr></table>  
<form action="entrega.jsp" method="get" name="forma" id="forma"  >
        ...
        <td colspan="4" align="center">
          <table width="100%"  border="0" cellspacing="1" cellpadding="0">
            <tr>
              ...
              <td align="center"><input name="sol2" type="button" class="botones" id="sol2" onClick="guardar('ENTREGADO')" value="Entregar"></td>
