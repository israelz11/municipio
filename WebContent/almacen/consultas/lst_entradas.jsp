...
<script type="text/javascript" src="lst_entradas.js"> </script>
...
<table width="95%" align="center"><tr><td><h1>Entradas - Listado de Entradas</h1></td></tr></table>
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="formulario">
  ...
  <tr >
    ...
    <sec:authorize ifAllGranted="ROLE_Almacen_PRIVILEGIOS_REPORTE_PDF_LISTADO_ENTRADAS">
    	<button name="cmdpdf" id="cmdpdf" onClick="getListadoEntradas()" title="Mostrar listado en formato PDF" type="button" class="button red middle"><span class="label" style="width:100px">Imprimir PDF</span></button>
    </sec:authorize>
    </td>
  </tr>
  <tr >
