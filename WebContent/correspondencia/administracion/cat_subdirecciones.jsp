...
<script type="text/javascript" src="../../dwr/interface/controladorAdministrarSubdireccionesRemoto.js"> </script>
...
<body >
<form name="forma" id="forma" method="get" action="cat_subdirecciones.action">
<br />
  <table width="95%" align="center"><tr><td><h1>Administración - Catálogo de Subdirecciones</h1></td></tr></table>
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="formulario">
    <tr>
      <td height="19">&nbsp;</td>
      <td><input type="hidden" id="ID_SUBDIRECCION" name="ID_SUBDIRECCION" value=""></td>      
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="86%"><input name="txtsubdireccion" type="text" class="input" id="txtsubdireccion" value="" size="70" maxlength="150" style="width:450px"/></td>
    </tr>
    <tr>
      <th height="30">*Responsable:</th>
      <td><input name="txtresponsable" type="text" class="input" id="txtresponsable" value="" size="70" maxlength="150" style="width:450px"/></td>
    </tr>
    <tr>
    ...
    <thead>
      <tr >
        <th width="3%" height="20" >
        	<img src="../../imagenes/cross.png" width="16" height="16" onClick="borrarSubdireccion()" style='cursor: pointer;' alt='Eliminar'></th>
        <th width="37%"  align="left" >Responsable</th>
        <th width="31%"  align="left" >Descripción</th>
      ...
      <c:forEach items="${detalles}" var="item" varStatus="itemStatus">
          <tr id='f<c:out value="${cont}"/>' onMouseOver="color_over('f<c:out value="${cont}"/>')" onMouseOut="color_out('f<c:out value="${cont}"/>')">
           ...
           <input type="checkbox" id="chksubdireccion" name="chksubdireccion" value="<c:out value='${item.ID_SUBDIRECCION}'/>"></td>
            ...
            <td align="center"><c:if test='${item.STATUS==1}'>ACTIVO</c:if><c:if test='${item.STATUS==0}'>INACTIVO</c:if></td>
             <td align="center"><img src="../../imagenes/page_white_edit.png" title="Editar" style="cursor:pointer" onClick="editarSubdireccion(<c:out value='${item.ID_SUBDIRECCION}'/>)">&nbsp;</td>
          </tr>
