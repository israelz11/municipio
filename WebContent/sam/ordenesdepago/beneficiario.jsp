...
<div id="tabuladores">
  ...
  <div id="fragment-general" align="left">
    ...
    <tr>
      ...
      <td><select name="tipo" class="form-control input-sm" id="tipo" style="width:150px" >
    ...
    <tr>
      ...
      <td><input name="rfc" type="text" class="form-control input-sm" id="rfc" value="<c:out value='${beneficiario.RFC}'/>"  maxlength="15" onBlur="upperCase(this)" style="width:150px" />
        <input type="hidden" name="idProveedor" id="idProveedor" value="<c:out value='${id}'/>">
        </td>
    </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">CURP :</span></th>
      <td><input name="curp" type="text" class="form-control input-sm" id="curp" value="<c:out value='${beneficiario.CURP}'/>"  maxlength="18" onBlur="upperCase(this)" style="width:150px" /></td>
    </tr>
    <tr>
      <th width="20%" height="30"><span class="Texto_Forma">**Raz&oacute;n Social :</span></th>
      <td><input name="razonSocial" type="text" class="form-control input-sm" id="razonSocial" value="<c:out value='${beneficiario.NCOMERCIA}'/>" style="width:350px"  maxlength="100" onBlur="upperCase(this)" /></td>
    </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">*Responsable 1 :</span></th>
      <td><input name="responsable" type="text" class="form-control input-sm" id="responsable" value="<c:out value='${beneficiario.BENEFICIAR}'/>" style="width:350px" maxlength="100" onBlur="upperCase(this)" /></td>
    </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">Responsable 2 :</span></th>
      <td><input name="responsable2" type="text" class="form-control input-sm" id="responsable2" value="<c:out value='${beneficiario.BENEFICIA2}'/>" style="width:350px" maxlength="100" onBlur="upperCase(this)" /></td>
      </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">*Tel&eacute;fonos :</span></th>
      <td width="80%"><input name="telefono" type="text" class="form-control input-sm" id="telefono" value="<c:out value='${beneficiario.TELEFONOS}'/>" style="width:350px" maxlength="100" onBlur="upperCase(this)" /></td>
    </tr>
    <tr>
...
<div id="fragment-fiscal" align="left">    
    ...
    <tr>
      ...
      <td width="80%"><input name="calle" type="text" class="form-control input-sm" id="calle" value="<c:out value='${beneficiario.DOMIFISCAL}'/>" style="width:350px" maxlength="60" onBlur="upperCase(this)" /></td>
    </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">*Colonia :</span></th>
      <td><input name="colonia" type="text" class="form-control input-sm" id="colonia" value="<c:out value='${beneficiario.COLONIA}'/>" style="width:350px" maxlength="40" onBlur="upperCase(this)" /></td>
      </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">*Estado :</span></th>
      <td><input name="estado" type="text" class="form-control input-sm" id="estado" value="<c:out value='${beneficiario.ESTADO}'/>" style="width:150px" maxlength="25" onBlur="upperCase(this)" /></td>
      </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">*Ciudad :</span></th>
      <td><input name="ciudad" type="text" class="form-control input-sm" id="ciudad" value="<c:out value='${beneficiario.CIUDAD}'/>" style="width:350px" maxlength="50" onBlur="upperCase(this)" /></td>
      </tr>
    <tr>
      <th height="30"><span class="Texto_Forma">*C&oacute;d. Postal :</span></th>
      <td><input name="cp" type="text" class="form-control input-sm" id="cp" value="<c:out value='${beneficiario.CODIGOPOST}'/>" style="width:150px" maxlength="5" onKeyPress=" return keyNumbero( event );" onBlur="upperCase(this)" /></td>
      </tr>
    <tr>
      <th height="30">&nbsp;</th>
      <td>&nbsp;</td>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="formulario" id="formaCaptura">
    ...
    <tr>
      ...
      <td width="80%"><select name="cbobanco" class="form-control input-sm" id="cbobanco" style="width:350px" >
    ...
    <tr>
      ...
      <td><input name="noCuenta" type="text" class="form-control input-sm" id="noCuenta" value="<c:out value='${beneficiario.NUM_CTA}'/>" style="width:150px" maxlength="150" onBlur="upperCase(this)" onkeypress=" return keyNumbero( event );" /></td>
    </tr>
    <tr>
      <th height="30">Tipo :</th>
      <td><select name="tipoCuenta" class="form-control input-sm" id="tipoCuenta" style="width:150px">
...
<table width="100%%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="35" align="center"><input  name="cmdcerrar" type="button" class="btn btn-cerrar input-sm" id="cmdcerrar"   value="Cerrar" style="width:150px" />
      <input  name="cmdguardar" type="button" class="btn btn-success input-sm" id="cmdguardar"   value="Guardar" style="width:150px" /></td>
  </tr>
</table>
</form>
</body>
