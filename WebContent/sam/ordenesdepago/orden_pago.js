...
function generarOPS(checkFacturas){
	...
	/* var fecha_op =obtiene_fecha($('#fecha2').val());//obtenemos la fecha del dia.............
	   var fecha_ =obtiene_fecha($('#fecha').val());//obtenemos la fecha del dia.............
	   alert ("Fecha: " +fecha_op);
	   aleret("prueba: "+fecha_);
	   console.log("prueba: "+ fecha_);*/
