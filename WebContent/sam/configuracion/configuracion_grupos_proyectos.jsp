...
<br />
  <table width="90%" align="center"><tr><td><h1>Configuración - Grupos de proyectos</h1></td></tr></table>
  ...
  <tr>
      ...
      <td><label>
        <select name="unidad" size="1" class="comboBox" id="unidad" onChange="pintarTablaDetalles()"  style="width:445px;">
    ...
    <tr>
      <th width="11%" height="30">Proyectos:</th>
      <td width="89%"><table width="100%"  border="0" align="center"  cellpadding="0" cellspacing="0" class="listas"  id="detallesTabla" >
        <thead>
          <tr >
            <th width="4%" height="20" ><input type="checkbox" name="todos" id="todos" ></th>
            <th width="12%"  align="center" >Proyecto</th>
            <th width="50%"  >Descripción</th>
            <th width="34%"  >Unidad Administrativa</th>
            </tr>
        </thead>
        <tbody>
        </tbody>
