...
<script type="text/javascript" src="configuracion_grupos_tipo_req.js"></script>
...
<br />
  <table width="90%" align="center"><tr><td><h1>Configuración - Grupos de tipos de Requisiciones</h1></td></tr></table>
  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" class="formulario">
    ...
    <tr>
      ...
      <td><label>
        <select name="grupo" size="1" class="comboBox" id="grupo" onChange="pintarTablaDetalles()" style="width:450px;">
