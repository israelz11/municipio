...
<table width="528" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="100"><a href="../archivos/Introduccion SAM 2011.mp4" target="_blank"><img src="../../imagenes/Mp4.png" width="100" height="100" border="0"></a></td>
    <td width="428"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><a href="../archivos/Introduccion SAM 2011.mp4" target="_blank">Introduccion al Sistema Administrativo Municipal (SAM)</a></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><span class="TextoNormalGris"><a href="#">Ver video</a> | <a href="../archivos/Introduccion SAM 2011.mp4">Descargar</a></span></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>Introduccion al Módulo de Requisiciones, OT, OS.</td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>Introducción al Módulo de Pedidos</td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>Introduccion al Módulo de Ordenes de Pago</td>
      </tr>
      <tr>
