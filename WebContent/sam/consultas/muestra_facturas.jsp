...
<table class="listas" border="0" align="center" cellpadding="0" cellspacing="0" width="95%">
  ...
  <c:forEach items="${listaFacturas}" var="item" varStatus="status" >
  <c:set var="cont" value="${cont+1}" /> 
        ...
        <td height="20" align="center"><c:out value='${item.NUM_PED}'/></td>
        <td width="14%" height="20" align="left"><c:out value='${item.NUM_REQ}'/></td>
