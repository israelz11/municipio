                    ...
                    <div class="row">
                      <div class="form-group">
                        ...
                        <div class="col-sm-3 form-group">
                            <select name="cbotipo" class="selectpicker form-control input-sm m-b" id="cbotipo" style="width:100%">
                              <option value="0">[Seleccione]</option>
						       	<c:forEach items="${tipoRequisicion}" var="item">
						        <option value='<c:out value="${item.Id_TipoRequisicion}"/>' 
						        <c:if test='${item.Id_TipoRequisicion==idTipoRequisicion}'> selected </c:if>>
                  ...
                  <div class="row">
                    <div class="form-group">
                        <div class="control-label col-sm-3">*Artículo/Producto/Servicio:&nbsp;</div>
							...
							<div class="col-sm-2">
								<input name="txtprecioestimado" type="text" class="form-control sm" id="txtprecioestimado" value="" <sec:authorize ifNotGranted="ROLE_Sam_PRIVILEGIOS_CAMBIAR_PRECIO_REQUISICIONES"></sec:authorize>/>
							</div>
                    </div>
                  </div>
    	        <!--Artículo, Precio-->
                  ...
                  <div class="row">
                    <div class="form-group">
                        <div class="control-label col-sm-3 ">*Descripción:&nbsp;</div>
                      		<div class="col-sm-2">
								<textarea id="txtdescripcion" name="txtdescripcion" rows="4" class="form-control sm" wrap="virtual" maxlength="300" style="width:400px"></textarea>
							</div>
					</div>
                  </div>     
           		<!--Nuevo lote-->
	        	...
	        	<!--Botones-->
                  <div class="row">
                    <div class="form-group">
                        <div class="control-label col-sm-3 "></div>
                        <div class="col-sm-6">
                        	<table width="100%" border="0"  style="text-align:left" class="table" id="listasConceptos">
							    <thead>
							        <tr >
