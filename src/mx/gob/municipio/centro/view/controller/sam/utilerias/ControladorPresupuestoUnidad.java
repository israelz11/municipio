...
@Controller
@RequestMapping("/sam/consultas/lst_presupuesto.action")
public class ControladorPresupuestoUnidad extends ControladorBase {	
	private static Logger log = Logger.getLogger(ControladorPresupuestoUnidad.class.getName());
	private ControladorPresupuestoUnidad(){}
	@Autowired
	...
	public String  requestGetControlador( Map modelo, HttpServletRequest request) {	
	    ...
	    return "sam/consultas/lst_presupuesto.jsp";
	}
